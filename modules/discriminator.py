...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_channels=3, block_expansion=64, num_blocks=4, max_features=512,
                 sn=False, use_kp=True, num_kp=10, kp_variance=0.01, **kwargs):
    ...
    def forward(self, x, kp=None):
        x = torch.nn.functional.interpolate(x, mode='bilinear', size=(256, 256), align_corners=True)
        feature_maps = []
        out = x
        if self.use_kp:
...
class MultiScaleDiscriminator(nn.Module):
    ...
    def forward(self, x, kp=None, detach=False):
        out_dict = {}
